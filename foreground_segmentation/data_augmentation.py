...
def add_noise_to_depth(depth_img):
    ...
    multiplicative_noise = np.random.gamma(1000, 0.001)
...
def random_morphological_transform(label, noise_params):
    ...
    while not valid_transform:
        ...
        x_min, y_min, x_max, y_max = utils.mask_to_tight_box(label)
...
def random_ellipses(label, noise_params):
    ...
    while not valid_transform:
        ...
        pixel_indices = utils.build_matrix_of_indices(H, W)
        ...
        # Sample ellipse radii and angles
        x_min, y_min, x_max, y_max = utils.mask_to_tight_box(new_label)
