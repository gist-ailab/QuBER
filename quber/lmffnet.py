...
class Init_Block(nn.Module):
    def __init__(self):
        ...
        self.init_conv = nn.Sequential(
            Conv(6, 32, 3, 2, padding=1, bn_acti=True),
...
class MAD(nn.Module):
    def __init__(self, c1=16, c2=32, classes=19):
        ...
        self.mid_layer_1x1 = Conv(128 + 6, c1, 1, 1, padding=0, bn_acti=False)

        self.deep_layer_1x1 = Conv(256 + 6, c2, 1, 1, padding=0, bn_acti=False)
        ...
        self.DwConv2 = Conv(256 + 6, 256 + 6, (3, 3), 1, padding=(1, 1), groups=256 + 6, bn_acti=True)
        self.PwConv2 = Conv(256 + 6, classes, 1, 1, padding=0, bn_acti=False)
...
class LMFFNet(nn.Module):
    def __init__(self, classes=3, block_1=3, block_2=8):
        super().__init__()
