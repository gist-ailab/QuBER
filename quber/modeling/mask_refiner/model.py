...
__all__ = ["QuBER", "INS_EMBED_BRANCHES_REGISTRY", "build_ins_embed_branch"]
        ...
        if "sem_seg" in batched_inputs[0] and "center" in batched_inputs[0] and "offset" in batched_inputs[0]:
            ...
            if self.eee_mask_on:
                if self.error_type == "quber":
                    ...
                    raise ValueError(f"Error type {self.error_type} not supported")
...
class QuBERInsEmbedHead(DeepLabV3PlusHead):
    """
