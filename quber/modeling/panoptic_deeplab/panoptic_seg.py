...
class PanopticDeepLab(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        for sem_seg_result, center_result, offset_result, input_per_image, image_size in zip(
            ...
            # processed_results.append({"center": c})
            # processed_results.append({"offset": o})
            ...
            if self.predict_instances:
                ...
                for panoptic_label in np.unique(panoptic_image_cpu):
                    ...
                    if isthing:
                        ...
                        # import cv2
                        # cv2.imwrite("sem_seg.png", (semantic_prob.round * 255).cpu().numpy().astype(np.uint8))
                        ...
                        # print(sem_scores, center_scores, instance.scores)
                        # Get bounding boxes
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if loss_type == "cross_entropy":
            ...
            self.loss = DeepLabBCE(ignore_label=ignore_value, top_k_percent_pixels=loss_top_k)
        else:
...
class PanopticDeepLabInsEmbedHead(DeepLabV3PlusHead):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # `head` is additional transform before predictor
        if self.use_depthwise_separable_conv:
            self.center_head = DepthwiseSeparableConv2d(
                decoder_channels[0],
                head_channels,
                kernel_size=5,
                padding=2,
