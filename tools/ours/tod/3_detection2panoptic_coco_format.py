...
python tools/ours/tod/3_detection2panoptic_coco_format.py \
    --input_json_file detectron2_datasets/TODv2/annotations/tod_v2_train_perturbated.json \
    --output_json_file detectron2_datasets/TODv2/annotations/tod_v2_train_panoptic_perturbated.json \
    --segmentations_folder detectron2_datasets/TODv2 \
    --categories_json_file detectron2_datasets/TODv2/annotations/panoptic_tod_categories.json
'''
