...
min_mask_ratio = 0.01
coco_anno_path = '/SSDe/seunghyeok_back/mask-refiner/detectron2_datasets/TODv2/annotations/tod_v2_train.json'
coco_anno = COCO(coco_anno_path)
img_ids = coco_anno.getImgIds()

purturbed_coco_anno_path = os.path.join(base_dir, 'annotations', 'tod_v2_train_perturbated.json'.format(split))
purturbed_coco_anno_json = {
    "info": {
        "description": "TOD v2 perturbated",
