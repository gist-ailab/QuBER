...
class MaskDecoderHQ(MaskDecoder):
    def __init__(self, model_type):
        ...
        weight = torch.load('/SSDe/seunghyeok_back/mask-refiner/sam/sam_hq_vit_h.pth')
        # select only weight in mask_decoder
        _weight = {}
        for k,v in weight.items():
            ...
            if 'image_encoder' in k:
                ...
                continue
        self.load_state_dict(_weight, strict=False)
...
def main(net, train_datasets, valid_datasets, args):
    ...
    if not args.eval:
        ...
        train_dataloaders, train_datasets = create_dataloaders(None,
                                                        my_transforms = [
                                                                    RandomHFlip(),
                                                                    LargeScaleJitter()
                                                                    ],
